package com.wenhuaijun.cartoonautosplit.imageLoader;
...
public class LoadBitmapTask implements Runnable{
    ...
    //用于回调bitmap的重载构造函数
    public LoadBitmapTask(Context context,EasyImageLoader.BitmapCallback callback,Handler handler,String uri,int reqWidth,int reqHeight) {
